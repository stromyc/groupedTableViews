...
class ClubPlayersTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        // Get players that have a matching ClubId
        self.playerInfo.getPlayersForClubID(clubNameSegueValue)
     
        let sortDescriptor = NSSortDescriptor(key: "displayOrder", ascending: true)
        //let playerClubMatchingPredicate = NSPredicate(format: "clubID = %@", clubNameSegueValue)
        ...
        print("playerinfoList count: \(playerInfoList.count)")
        
        print("View did load playerlist")
                self.navigationItem.title = titleOfPage
...
//        self.playerInfoList = self.playerInfo.getEntities(sortedBy: sortDescriptor, matchingPredicate: playerClubMatchingPredicate)
        ...
        print("playerInfo count: \(playerInfo.entityList.count)")
        print("playerInfoList count: \(playerInfoList.count)")
